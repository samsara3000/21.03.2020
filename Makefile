...
matrix01.o: matrix.c
	gcc -g -c -O3 matrix.c -o matrix01.o
main01.o: main01.c 
	gcc -g -c -Wall main01.c -o main01.o
a01.o: a01.c
	gcc -o a01.o -Wall -g -c -O3 a01.c 
...
matrix05.o: matrix.c
	gcc -g -c -O3 matrix.c -o matrix05.o
main05.o: main05.c
	gcc -g -c -Wall main05.c -o main05.o
a05.o: a05.c
	gcc -o a05.o -Wall -g -c -O3 a05.c

a06.out: main06.o a06.o matrix06.o
	gcc -o a06.out -Wall -g main06.o a06.o matrix06.o
matrix06.o: matrix.c
	gcc -g -c -O3 matrix.c -o matrix06.o
main06.o: main06.c
	gcc -g -c -Wall main06.c -o main06.o
a06.o: a06.c
	gcc -o a06.o -Wall -g -c -O3 a06.c

a07.out: main07.o a07.o matrix07.o
	gcc -o a07.out -Wall -g main07.o a07.o matrix07.o
matrix07.o: matrix.c
	gcc -g -c -O3 matrix.c -o matrix07.o
main07.o: main07.c
	gcc -g -c -Wall main07.c -o main07.o
a07.o: a07.c
	gcc -o a07.o -Wall -g -c -O3 a07.c
	
a08.out: main08.o a08.o matrix08.o
	gcc -o a08.out -Wall -g main08.o a08.o matrix08.o
matrix08.o: matrix.c
	gcc -g -c -O3 matrix.c -o matrix08.o
main08.o: main08.c
	gcc -g -c -Wall main08.c -o main08.o
a08.o: a08.c
	gcc -o a08.o -Wall -g -c -O3 a08.c
	
a09.out: main09.o a09.o matrix09.o
	gcc -o a09.out -Wall -g main09.o a09.o matrix09.o
matrix09.o: matrix.c
	gcc -g -c -O3 matrix.c -o matrix09.o
main09.o: main09.c
	gcc -g -c -Wall main09.c -o main09.o
a09.o: a09.c
	gcc -o a09.o -Wall -g -c -O3 a09.c
	
a10.out: main10.o a10.o matrix10.o
	gcc -o a10.out -Wall -g main10.o a10.o matrix10.o
matrix10.o: matrix.c
	gcc -g -c -O3 matrix.c -o matrix10.o
main10.o: main10.c
	gcc -g -c -Wall main10.c -o main10.o
a10.o: a10.c
	gcc -o a10.o -Wall -g -c -O3 a10.c
